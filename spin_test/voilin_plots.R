...
for (model in models) {
 ...
 #spin_without_target_col <- (lh_spin_df[,2:1001] + rh_spin_df[,2:1001])/2
  ...
  melted_df_spin_results <- rbind(t(spin_without_target_col[1,]), 
                                  t(spin_without_target_col[2,]),
                                  t(spin_without_target_col[3,]),
                                  t(spin_without_target_col[4,]),
                                  t(spin_without_target_col[5,]),
                                  t(spin_without_target_col[6,]),
                                  t(spin_without_target_col[7,]))
  ...
  means <- as.vector(rowMeans(spin_without_target_col))
