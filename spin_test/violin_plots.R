...
models_for_stats = c("gam_sex", "pos_gam_sex", "neg_gam_sex","lm_exec_accuracy", "pos_lm_exec_accuracy", "neg_lm_exec_accuracy")
models_for_plots = c("gam_sex", "lm_exec_accuracy")
