...
%custommap(1,:)=[0 0 0];
custommap(2,:)=[121 14 134];
custommap(3,:)=[87 141 183];
custommap(4,:)=[4 117 19];
custommap(5,:)=[221 65 240];
custommap(6,:)=[185 222 144];
custommap(7,:)=[247 163 46];
custommap(8,:)=[213 61 81];
