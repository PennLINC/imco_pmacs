function PBP_vertWiseEffect_Erica_Ts_Yeo7_colors(LH,RH,name)% pretty picture code, AAB 4/2018 - AP 5/1/20 - Updated to threshold according to input - 1/12/21
...
custommap(1,:)=[201 201 201];
%custommap(1,:)=[0 0 0];
custommap(2,:)=[120 18 134];
custommap(3,:)=[70 130 180];
custommap(4,:)=[0 118 14];
custommap(5,:)=[196 58 250];
custommap(6,:)=[220 248 164];
custommap(7,:)=[230 148 34];
custommap(8,:)=[205 62 78];
%custommap(9,:)=[0 0 0]
custommap=custommap/255;
custommap=brighten(custommap,.4);
