...
%custommap = customcolormap(linspace(0,1,6), {'#f5f9f3','#d5e2f0','#93c5dc','#4295c1','#2265ad','#062e61'});
custommap = customcolormap(linspace(0,1,6), {'#410149','#762a84','#9b6fac','#c1a5cd','#e7d4e8','#faf6f7'});
%custommap=flipud(custommap);

%mycustommap fushion
%custommap = customcolormap(linspace(0,1,11), {'#7f3c0a','#b35807','#e28212','#f9b967','#ffe0b2','#f8f7f7','#cae9e3','#81cdc1','#379692','#01665e','#003d2e'});
...
%custommap=brighten(custommap,-.25);
%custommap = customcolormap(linspace(0,1,11), {'#860454','#c51b7c','#dc75ab','#f0b7da','#ffdeef','#f8f7f7','#e5f4d9','#b9e084','#7fbc42','#4d921e','#276418'});
