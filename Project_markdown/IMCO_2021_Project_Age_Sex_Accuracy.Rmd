...
###post: 2 violin plots per model. Violin plot x axis - yeo networks, y axis - proportion of vertices within networks. dotted lines - mean from permutations
   ...
   #### plots are saved in /project/imco/baller/results/images
   #### You will also get a table that tells you the p value (uncorrected) for each network within each model. Stats saved in /baller/results/coupling_accuracy/spin_test_results/spin_stats_gam_sex_lm_exec_acc_all_pos_neg. Change the outdir name at the top of the script.
...
### dependencies: Using R 3.6.3 but any R will do. Libraries to include listed below. You must source imco_functions.R -> it is commented out here but you can uncomment if running this section separately.
