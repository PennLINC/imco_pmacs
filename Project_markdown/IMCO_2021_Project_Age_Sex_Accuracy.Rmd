...
```{r coupling_accuracy_fx_T, eval=FALSE}
##################################################
...
dev.off()
  ...
  ###################################
### Histogram of Executive Accuracy ###
#######################################
subjDemos <- subjDemos(which(!is.na(subjDemos$F1_Exec_Comp_Res_Accuracy))) #remove NA's
pdf(paste0(homedir, "/baller/results/supplementary_figures/Executive_Accuracy_histo.pdf"))
  hist(subjDemos$F1_Exec_Comp_Res_Accuracy, xlab = "Z-score", col = "lightblue", main = "Executive Accuracy Distribution")
dev.off()
...
PBP_vertWiseEffect_Erica_mean_coupl_plasma_unc('/project/imco/baller/results/mean_maps/n831_lh.coupling_coef_alff_cbf.fwhm15.fsaverage5.csv','/project/imco/baller/results/mean_maps/n831_rh.coupling_coef_alff_cbf.fwhm15.fsaverage5.csv','coupling_mean_plasma_uncor_just_pos')
...
SpinPermuFS('/project/imco/baller/results/coupling_accuracy/lh_gam_age_t_fdr05_Yeo7_1_0_-1.csv','/project/imco/baller/results/coupling_accuracy/rh_gam_age_t_fdr05_Yeo7_1_0_-1.csv',1000,'/project/imco/baller/results/coupling_accuracy/spin_test_results/gam_age_spin_results_yeo_1_0_-1_output','gam_age')
SpinPermuFS('/project/imco/baller/results/coupling_accuracy/lh_pos_gam_age_t_fdr05_Yeo7_1_0_-1.csv','/project/imco/baller/results/coupling_accuracy/rh_pos_gam_age_t_fdr05_Yeo7_1_0_-1.csv',1000,'/project/imco/baller/results/coupling_accuracy/spin_test_results/pos_gam_age_spin_results_yeo_1_0_-1_output','pos_gam_age')
SpinPermuFS('/project/imco/baller/results/coupling_accuracy/lh_neg_gam_age_t_fdr05_Yeo7_1_0_-1.csv','/project/imco/baller/results/coupling_accuracy/rh_neg_gam_age_t_fdr05_Yeo7_1_0_-1.csv',1000,'/project/imco/baller/results/coupling_accuracy/spin_test_results/neg_gam_age_spin_results_yeo_1_0_-1_output','neg_gam_age')
...
SpinPermuFS('/project/imco/baller/results/mean_maps/n831_lh.coupling_coef_alff_cbf.fwhm15.fsaverage5.csv','/project/imco/baller/results/mean_maps/n831_rh.coupling_coef_alff_cbf.fwhm15.fsaverage5.csv',1000,'/project/imco/baller/results/coupling_accuracy/spin_test_results/mean_coupling_spin_results_output','mean_coupling_results')
SpinPermuFS('/project/imco/baller/results/lh_mean_coupling_med_wall_-1.csv','/project/imco/baller/results/rh_mean_coupling_med_wall_-1.csv',1000,'/project/imco/baller/results/coupling_accuracy/spin_test_results/mean_coupling_spin_results_med_wall_-1_output','mean_coupling_results_med_wall_-1')
```
