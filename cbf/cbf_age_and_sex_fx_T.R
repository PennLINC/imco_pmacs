...
for (i in 1:10242) {
  ...
  sex_lm_model <- lm(lh_cbf_asl[,curcol] ~ pcaslRelMeanRMSMotion + restRelMeanRMSMotion + osex, data=lh_cbf_asl)
  ...
  lh_lm_sex_t_uncor[i] <- summary(sex_lm_model)$coeff[4,3]
}
...
for (i in 1:10242) {
  ...
  sex_lm_model <- lm(rh_cbf_asl[,curcol] ~ pcaslRelMeanRMSMotion + restRelMeanRMSMotion + osex, data=rh_cbf_asl)
  ...
  rh_lm_sex_t_uncor[i] <- summary(sex_lm_model)$coeff[4,3]
